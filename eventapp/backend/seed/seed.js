...
const run = async () => {
  ...
  const events = await Event.insertMany([
    ...
    },
    {
      ...
      description: "Experience the timeless masterpiece of Orson Welles on the big screen with complimentary popcorn and beverages.",
      category: "Movies",
      bannerImage: "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800",
      venue: "Retro Cinema Hall",
      city: "Bengaluru",
    ...
    },
    {
      ...
      description: "Celebrate the festival of colors with organic Gulal, rain dances, dhol beats, and electronic dance music sets.",
      category: "Festivals",
    ...
    },
    {
      ...
      description: "Bring your favorite book, grab a hot brew, and enjoy a quiet, cozy afternoon of silent reading with fellow bookworms.",
      category: "Other",
      bannerImage: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800",
      venue: "The Book Nook Cafe",
      city: "Hyderabad",
